package com.tdtu.lab07_2;

import com.tdtu.lab07_2.model.Student;
import com.tdtu.lab07_2.service.StudentServiceImpl;
...
public class Lab072Application implements CommandLineRunner {
    @Autowired
    StudentServiceImpl studentService;

    public static void main(String[] args) {
        SpringApplication.run(Lab072Application.class, args);
    }
